...
var constants = {
    URLS: {
        ...
        CREATECLEANING: "http://kc-fengniaowu-talos.dev.kolibre.credit/api/DomesticService/CreateCleaning",
        GETTENANTCLEANINGS: "http://kc-fengniaowu-talos.dev.kolibre.credit/api/DomesticService/GetTenantCleanings",
        GETTENANTCLEANING:"http://kc-fengniaowu-talos.dev.kolibre.credit/api/DomesticService/GetTenantCleaning?id={0}",
        CANCELCLEANING:"http://kc-fengniaowu-talos.dev.kolibre.credit/api/DomesticService/CancelCleaning",
        CREATEREPAIR: "http://kc-fengniaowu-talos.dev.kolibre.credit/api/DomesticService/CreateRepair",
        GETTENANTREPAIRS: "http://kc-fengniaowu-talos.dev.kolibre.credit/api/DomesticService/GetTenantRepairs",
        GETTENANTREPAIR:"http://kc-fengniaowu-talos.dev.kolibre.credit/api/DomesticService/GetTenantRepair?id={0}",
        CANCELREPAIR:"http://kc-fengniaowu-talos.dev.kolibre.credit/api/DomesticService/CancelRepair",
